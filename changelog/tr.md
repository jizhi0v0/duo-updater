...
**`duo check` artık gerçekte denetleyemediği durumlarda “Her şey güncel.” demiyor.** TestFlight’ı okuyamadığında ya da uygulama taraması yarıda bırakıldığında artık bunu belirtiyor.
