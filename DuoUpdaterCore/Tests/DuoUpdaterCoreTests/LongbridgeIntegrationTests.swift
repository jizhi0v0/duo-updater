...
// The preview manifest captured here (0.19.0-preview.1) carried NO `sha256` — a
// real structural difference from stable's at the time, preserved so the fixture
// cannot flatter the recipe.
