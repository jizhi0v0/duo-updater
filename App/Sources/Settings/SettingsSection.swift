...
enum SettingsSection: String, CaseIterable, Identifiable {
    ...
    private var localizedKeywords: [String] {
        let list: String
        switch self {
        case .general:     list = String(localized: "launch, login, frequency, notify, relaunch, restart, concurrency, app store, self-updating, vendor", comment: "Comma-separated extra search terms for the General settings page")
    ...
    private var englishAliases: [String] {
        switch self {
        case .general:     return ["launch", "login", "frequency", "notify", "relaunch", "restart", "concurrency", "app store", "mas", "self-updating", "vendor"]
