...
## channel-verify 状态
- ✓ **stable 已验证 2026-06-04**（`--scan`，本机装的 `io.tailscale.ipn.macsys` 1.98.5/101.98.5）。VendorProbe 应答 1.98.5=installed，无幽灵更新。`unstable` 轨无 recipe、不在范围。证据：`application-test/records/io-tailscale-ipn-macsys.md`
