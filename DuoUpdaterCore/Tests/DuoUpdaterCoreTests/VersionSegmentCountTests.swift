...
struct VersionSegmentCountTests {
    ...
    @Test func aDelimitedPatternAcceptsFewerSegmentsThanBefore() throws {
        ...
        let probe = try #require(recipe("com.microsoft.VSCode"))
        #expect(extract(#"{"name":"1.133.0"}"#, probe) == "1.133.0")
        #expect(extract(#"{"name":"2.0"}"#, probe) == "2.0")
    }
    ...
    @Test func aDelimitedPatternAcceptsMoreSegmentsThanBefore() throws {
        ...
        let probe = try #require(recipe("com.microsoft.VSCode"))
        #expect(extract(#"{"name":"1.133.0.5"}"#, probe) == "1.133.0.5")
    }
    ...
    @Test func wideningCannotDriftOntoANeighbouringNumber() throws {
        ...
        #expect(extract(body, probe) == "1.133.0")
    }
    ...
    @Test func whatsAppNoLongerHardCodesItsMajorVersion() throws {
        ...
        let probe = try #require(recipe("net.whatsapp.WhatsApp"))
        #expect(extract("WhatsApp-2.26.33.15.dmg", probe) == "26.33.15")
        #expect(extract("WhatsApp-3.26.33.15.dmg", probe) == "26.33.15")
    }
    ...
    @Test func plexStaysAtThreeSegmentsBecauseItHasNoClosingDelimiter() throws {
        ...
        let probe = try #require(recipe("tv.plex.desktop"))
        let body = #"{"computer":{"MacOS":{"version":"1.115.0.426-4e960a1d"}}}"#
        #expect(extract(body, probe) == "1.115.0")
    }
    ...
    @Test func sublimeTextKeepsItsMajorPinned() throws {
        ...
        let probe = try #require(recipe("com.sublimetext.4"))
        let body = #"class="latest"><i>Version:</i> Build 4200"#
        #expect(extract(body, probe) == "Build 4200")
        let five = #"class="latest"><i>Version:</i> Build 5001"#
        #expect(extract(five, probe) == nil, "a Sublime 5 build must not be offered here")
    }
}
