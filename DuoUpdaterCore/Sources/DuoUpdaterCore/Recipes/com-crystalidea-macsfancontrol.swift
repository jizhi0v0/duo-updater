...
enum com_crystalidea_macsfancontrol {
    static let set = AppRecipeSet(
        ...
        githubRules: [
        // History: docs/app-audits/com-crystalidea-macsfancontrol.md#历史与实测
        ...
        // a notarized Developer ID build (Team ACC5R6RH47, Ilya Parniuk) reporting
        // version == tag, bundle id com.crystalidea.macsfancontrol matching the
        // install → passes the gate. Two
