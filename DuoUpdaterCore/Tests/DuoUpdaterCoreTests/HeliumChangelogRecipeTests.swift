...
///
/// Fixture: the two newest release objects from
/// `api.github.com/repos/imputnet/helium-macos/releases` (fetched 2026-09-03) —
/// 0.16.4.1, still flagged prerelease, and 0.16.3.1, the version the appcast was
/// serving. Their bodies use different line endings (`\n` and `\r\n`), which is
/// how the vendor actually writes them.
@Suite struct HeliumChangelogRecipeTests {
    ...
    @Test func theStillUnreleasedPrereleaseIsSkipped() throws {
